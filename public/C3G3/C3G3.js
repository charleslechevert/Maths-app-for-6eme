app = {
    ...
    createGrid(gridSize = 8, cellSize = 25) {
        ...
        // Je créer mon élément
          ...
          // Je créer mon élément
            ...
            cellElm.style.backgroundImage = 'url(/C3G3/pavement.png)'
      ...
      placeSprite() {
        ...
        createSprite.src = "/C3G3/sprite.png";
      ...
      generateNearNumber(){
        ...
        if(document.getElementById(app.leftPosition).style.backgroundImage == 'url("/C3G3/pavement.png")' ) {
            document.getElementById(app.leftPosition).textContent = numbers[1]
        }
        
        if(document.getElementById(app.rightPosition).style.backgroundImage == 'url("/C3G3/pavement.png")') {
    ...
    moveSprite(event) {
        ...
        if (event.target.textContent != '' && event.target.textContent % app.divisor == 0) {
            ...
            event.target.style.backgroundImage = "url(/C3G3/vortex2.png)" //create vortex effect if wrong
            event.target.textContent = ''
            ...
            setTimeout(() => event.target.style.backgroundImage = "url(/C3G3/pavement.png)", 800) //create vortex effect if wrong
    ...
    endOfGrid() {
        if (document.querySelector('.sprite').parentElement.id < 9) {
            ...
            for(let i=0;i<document.querySelectorAll('.cell').length;i++) {
                document.querySelectorAll('.cell')[i].style.backgroundImage="url(/C3G3/pavement.png)"
            }
        }
